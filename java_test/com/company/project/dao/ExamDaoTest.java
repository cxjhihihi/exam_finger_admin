...
public class ExamDaoTest extends BaseDaoTestCase{
	...
	public static ExamQuery newExamQuery() {
		ExamQuery query = new ExamQuery();
		query.setPageNumber(pageNumber);
		query.setPageSize(pageSize);
		query.setSortColumns(null);
		
	  	query.setExamname(new String("1"));
	  	query.setMemo(new String("1"));
		return query;
	}
